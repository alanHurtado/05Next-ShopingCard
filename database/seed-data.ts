import bcryp from "bcryptjs"; // ? libreria para encriptar password
...
export const initialData: SeedData = {
  users: [
    {
      name: "Alan Astorga Hurtado",
      email: "alan@gmail.com",
      password: bcryp.hashSync("123456"),
      role: "admin",
    },
    {
      name: "Jose Matias Hurtado",
      email: "Jose@gmail.com",
      password: bcryp.hashSync("123456"),
      role: "admin",
    },
    {
      name: "Viridiana Hurtado",
